...
create database PROVIDER_GRAPH_DATABASE_NAME;
use PROVIDER_GRAPH_DATABASE_NAME;
...
/* Load data from CSV */
LOAD DATA INFILE '/path/to/datafile/referral.csv' INTO TABLE provider_directed_graph
