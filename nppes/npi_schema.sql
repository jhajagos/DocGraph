...
alter table healthcare_provider_taxonomy_processed add is_durable_medical_equipment__medical_supplies boolean;
...
update healthcare_provider_taxonomy_processed set is_durable_medical_equipment__medical_supplies = case when  flattened_taxonomy_string like '%332B00000X%' or flattened_taxonomy_string like '%332BC3200X%' or flattened_taxonomy_string like '%332BD1200X%' or flattened_taxonomy_string like '%332BN1400X%' or flattened_taxonomy_string like '%332BP3500X%' or flattened_taxonomy_string like '%332BX2000X%' then 1 else 0 end;
